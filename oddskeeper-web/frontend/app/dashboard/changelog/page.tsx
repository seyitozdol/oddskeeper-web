...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      {
        en: "Upcoming Events: Bets10 odds now cover UEFA Nations League matches (Türkiye - France and the rest of the group), and national-team names in Turkish (Fransa, İtalya, Belçika...) are matched to the fixture list correctly.",
  ...
  },
  {
    ...
    items: [
      ...
      {
        en: "Fixtures: the league's upcoming matches are listed automatically, week by week (Week dropdown like football; finished weeks drop to the bottom), with the Bets10 fixture id, handicap and total points line when Bets10 has the match. \"Fill from Bets10\" adds the week's matches that have an id, \"Add\" adds one, and existing fixtures get an \"Apply\" suggestion. Manual entry stays (with a week box). Instead of 1X2 odds, basketball fixtures carry total points and handicap boxes (Bets10 currently sends only the handicap; the total fills in once it appears in the feed). The Model tab's fixture list is grouped by week too.",
        tr: "Fikstürler: ligin yaklaşan maçları hafta hafta otomatik listelenir (futboldaki gibi Hafta seçimi; biten haftalar en alta iner); Bets10'da olan maçta fikstür id'si, handikap ve toplam sayı çizgisi de gelir. \"Bets10'dan doldur\" haftanın id'li maçlarını, \"Ekle\" tekini ekler; mevcut fikstürlere \"Uygula\" önerisi çıkar. Manuel ekleme aynen duruyor (hafta kutusuyla). 1X2 oranı yerine basketbol fikstürlerinde toplam sayı ve handikap kutuları var (Bets10 şimdilik yalnız handikap gönderiyor; toplam feed'e girince dolar). Model sekmesindeki fikstür listesi de haftaya göre gruplu.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: {
      ...
      tr: "Takım kart sayıları: yalnız sahada görülen kartlar",
    },
    tag: TAG_FIX,
    items: [
      {
      ...
      },
      {
        ...
        tr: "Header'daki Shortcuts menüsü imleç üzerinden ayrılır ayrılmaz kapanıyor; ikona tıklamak menüyü artık açık kilitlemiyor.",
      },
    ],
  },
  {

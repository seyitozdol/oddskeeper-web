  ...
  return (
    <section className="w-full">
      <div className="rounded-2xl border border-line bg-card p-8">
        ...
        <div className="mt-4">
          <PlayerProfileTabs name={normalizePlayerName(player.player_name)} teamName={player.team_name} position={player.position} height={player.height_cm} photoUrl={player.image_url} comps={comps} />
        </div>
      </div>
    </section>
  );

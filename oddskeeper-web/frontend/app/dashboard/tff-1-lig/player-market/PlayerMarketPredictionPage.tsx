...
// TFF 1. Lig kopyasi: app/dashboard/player-market-prediction ile ayni UI/akis
// (5 sekme). Veri katmani ./queries (tff1_* kaynaklari), hesaplar TSL
// modulundeki compute'tan aynen import edilir (saf/lig-bagimsiz).
...
// Export gecmisi: bu kopya 1. Lig (tff1). Super Lig kopyasi "tsl" kullanir.
const HISTORY_LEAGUE = "tff1";
...
export default function PlayerMarketPredictionPage({
  ...
  // team_id -> logo_url (tff1_team_logos_v1); logosu olmayan takim adsiz kalir.

...
// TFF 1. Lig kopyasi: app/dashboard/player-market-prediction/list-tabs.tsx
// ile birebir ayni UI. Kopyalandi cunku sekmeler ./queries tiplerine bagli
// (DirectoryPlayer/UpcomingFixture kimlikleri farkli: slug yerine id).
// Farklar: Oyuncu Listesi'nde ulke kolonu yok (tff1 kadro verisinde uyruk
// gosterimi istenmedi), logo/ID anahtarlari team_id/player_id.
...
// ─── Player List tab ──────────────────────────────────────────────────────────
// Guncel kadrolardaki tum oyuncular; ID kolonu pm_player_ids'e (league='tff1')
...
// ve ozel marketler analytics.pm_markets'a (league='tff1') kaydedilir.
...
// (league='tff1') yazar; Model'deki Ekle akisi bu kayitlari kullanir.

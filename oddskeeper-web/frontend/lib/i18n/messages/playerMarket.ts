...
export const playerMarket = defineMessages({
  en: {
    ...
    statusConfigTitle: "Status Rules",
    statusConfigHint: "Infers player status from the team's last matches (priority: Out > Starter > Sub). \"Use last match only\" overrides the rules.",
    statusWindowUnit: "matches",
    statusTimesUnit: "×",
    statusRoleStarter: "Starter",
    statusRoleSub: "Sub",
    statusRoleOut: "Out",
    statusCondStarter: "started (XI)",
    statusCondSub: "played (incl. sub)",
    statusCondOut: "did not play (not in squad)",
    statusLastOnly: "Use last match only (overrides rules)",
    ...
    betsApply: "Apply",
    betsHint: "Bets10 fixture id suggestion",
    newLabel: "New",
    deleteLabel: "Delete",
  ...
  tr: {
    ...
    statusConfigTitle: "Status Kuralları",
    statusConfigHint: "Oyuncu durumunu takımın son maçlarından çıkarır (öncelik: Out > Starter > Sub). \"Sadece son maça göre\" seçiliyse kuralları ezer.",
    statusWindowUnit: "maç",
    statusTimesUnit: "kez",
    statusRoleStarter: "Starter",
    statusRoleSub: "Sub",
    statusRoleOut: "Out",
    statusCondStarter: "ilk 11 başladı",
    statusCondSub: "sahaya çıktı (yedek dahil)",
    statusCondOut: "oynamadı (kadroda yok)",
    statusLastOnly: "Sadece son maça göre (diğer kuralları ezer)",
    ...
    betsApply: "Uygula",
    betsHint: "Bets10 fikstür id önerisi",
    newLabel: "Yeni",
    deleteLabel: "Sil",

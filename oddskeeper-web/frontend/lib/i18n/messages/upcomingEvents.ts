...
export const upcomingEvents = defineMessages({
  en: {
    ...
    openMatchPage: "click to open the match page",
    openMatchSearch: "click to find the match on the site",
    openSbManager: "open the fixture in SB Manager",
    oddsListed: "Listed",
  ...
  tr: {
    ...
    openMatchPage: "maç sayfasını açmak için tıkla",
    openMatchSearch: "maçı sitede bulmak için tıkla",
    openSbManager: "fikstürü SB Manager'da aç",
    oddsListed: "Listede",

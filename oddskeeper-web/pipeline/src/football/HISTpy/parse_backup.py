...
MATCH_URLS = [
    "https://optaplayerstats.statsperform.com/en_GB/soccer/s%C3%BCper-lig-2025-2026/97zghcaoec1isvvdkh9ud50d0/match/view/888oseoozq8b89mcdl2mis2l0/match-summary",
]
...
def parse_summary_player_table(table_element):
    ...
    for row in body_rows:
        ...
        for td in td_elements:
            values.append(coerce_value(element_text(td)))
...
def print_result_summary(result):
    ...
    points_sections = result["opta_points_stats"]["stats_sections"]
    details_sections = result["match_details"]["details_sections"]
    ...
    print("Summary sections:", len(result["match_summary"]["player_stats_sections"]))
...
def main():
    ...
    try:
        for idx, input_url in enumerate(MATCH_URLS, start=1):
            logging.info(f"{idx}/{len(MATCH_URLS)} başladı")

-- Takım sayfası roster'ına ROL kolonu için season/leaderboard view'larına role ekle.
-- (pp zaten sofascore_player_id / image_url'den geliyor.) Additive: role SONA eklenir.
--   BSL  : bb_player_season_stats_v1  <- bb_player_role_v1.role
--   EL/EC: el_player_leaderboard_v1   <- el_player_role_v1.role

-- ============================================================
-- BSL season stats: role ekle (scalar subquery, sezon+takım+oyuncu)
-- ============================================================
...
-- ============================================================
-- EL/EC leaderboard: role ekle (scalar subquery, comp+sezon+takım+oyuncu)
-- ============================================================

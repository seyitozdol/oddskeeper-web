-- ROLLBACK: yeni STS marketlerini ve enabled bayragini kaldirir.

delete from msm.template where market in ('Crosses', 'Interceptions', 'Long Balls');
delete from msm.market_config where market in ('Crosses', 'Interceptions', 'Long Balls');

alter table msm.market_config drop column if exists enabled;

-- RPC'yi onceki haline dondur (2026-08-19_msm_market_supremacy_divisor.sql govdesi).
